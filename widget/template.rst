...
Если в определении :term:`роута <роут>` указано свойство ``routeId`` (уникальный идентификатор роута), то в шаблоне
виджета есть возможность сформировать URL по этому идентификатору и параметрам с помощью плагина ``#url``.
